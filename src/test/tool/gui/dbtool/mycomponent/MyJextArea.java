 ...
 */
public class MyJextArea extends JTextArea implements DropTargetListener {

	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(MyJextArea.class);
	...
	public MyJextArea(boolean isShowFindMenu){
